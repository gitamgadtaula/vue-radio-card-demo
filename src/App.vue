<template>
  <div>
    ...
    <section class="bg-white dark:bg-gray-800">
      <div class="container px-6 py-8 mx-auto">
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div
            class="overflow-hidden p-0.5 mt-6 border rounded-lg dark:border-gray-700"
          >
        ...
        <div
          class="grid gap-6 mt-16 -mx-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
        >
          <div
    ...
    <radio-card v-model="selected" :options="items" title="Choose your plan">
